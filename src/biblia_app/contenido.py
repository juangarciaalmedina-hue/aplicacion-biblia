    ...
    def construir_prompt_chat_suenos() -> str:
        ...
        prompts = {
            "es": (
                ...
                "Da siempre al menos dos posibles lecturas. Primero escribe literalmente 'Interpretación principal:' y explica la lectura que consideres más probable con lo contado. Después escribe literalmente 'Otra posible interpretación podría ser:' y ofrece una alternativa prudente. No respondas con una sola interpretación. "
                ...
                "Responde como en un chat real, con frases cortas y naturales. "
                "Normalmente responde en 5 a 7 frases breves, sin Markdown. Usa siempre las etiquetas 'Interpretación principal:' y 'Otra posible interpretación podría ser:' para que las dos lecturas queden claras. "
